...
public class Skeleton extends BaseEnemy {
    ...
    private static final float ATTACK_DURATION = 0.30f; // тривалість слеша
    private static final float ATTACK_COOLDOWN = 1.5f; // кулдаун між ударами
    private static final int   ATTACK_DAMAGE   = 30;    // Шкода одного удару
    ...
    public Skeleton(float x, float y, Texture texture) {
        super(
            x, y,
